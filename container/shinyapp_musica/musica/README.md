This is a fork of the Mutational Signature in Cancer here: https://github.com/marcos-diazg/musica
This fork has been heavily modified to remove most user inputs and allow loading of vcfs via the url

The paths to the vcfs in Answer is currently hard coded in server.R. Make the appriopriate change to the path if needed.
