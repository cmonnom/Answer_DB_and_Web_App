...
shinyUI(fluidPage(
   ...
   #Title
   titlePanel(title=div(a(img(src="musica.png"), href="http://bioinfo.ciberehd.org/GPtoCRC/en/tools.html"),"\t\tMutational Signatures in Cancer (customized for Answer)"),windowTitle = "MuSiCa - Mutational Signatures in Cancer"),
   sidebarLayout(
