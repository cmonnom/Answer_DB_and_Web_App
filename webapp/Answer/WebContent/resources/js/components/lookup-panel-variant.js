    ...
    <v-card>
        ...
        <v-card-text class="pl-2 pr-2 pt-1">
            ...
            <div v-if="oncoKBVariantSummary">
                ...
                <v-tooltip bottom>
                <v-btn slot="activator" icon :href="oncoKBVariantSummary.oncokbVariantUrl" target="_blank" @click.stop class="primary--text"><v-icon>mdi-open-in-new</v-icon></v-btn>
                <span>Open Variant in OncoKB</span>
                </v-tooltip>
                <div class="pa-2 mb-2" v-for="indication in oncoKBVariantSummary.indications" :key="indication.drugs">
         ...
         <v-card>
             ...
             <v-card-text class="pl-2 pr-2 pt-1">
                 ...
                 <div v-if="oncoKBVariantSummary">
                     ...
                     <div class="pa-2 mb-2" v-for="indication in oncoKBVariantSummary.investigationalIndications" :key="indication.drugs">
                     <v-divider class="pb-3"></v-divider>
