...
public class LOINCVariantCategory {
	...
	static {
		loincCodes.put("snp", new String[] {"Simple","LA26801-3"});
		loincCodes.put("cnv", new String[] {"Structural","LA26802-1"});
		loincCodes.put("translocation", new String[] {"Structural","LA26802-1"});
	}
