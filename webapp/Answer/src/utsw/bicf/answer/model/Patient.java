...
//Just a transient object. Not a table.
//All data should be fetch dynamically using Clarity API
public class Patient {
	...
	LocalDate orderDate;
	LocalDate tumorCollectionDate;
	LocalDate labReceivedDate;
	...
	public void setLabAccessionNb(String labAccessionNb) {
		this.labAccessionNb = labAccessionNb;
	}
	...
	public void setGermlineSpecimenNb(String germlineSpecimenNb) {
		this.germlineSpecimenNb = germlineSpecimenNb;
	}
	...
	public LocalDate getTumorCollectionDate() {
		return tumorCollectionDate;
	}
	public void setTumorCollectionDate(LocalDate tumorCollectionDate) {
		this.tumorCollectionDate = tumorCollectionDate;
	}
	public LocalDate getLabReceivedDate() {
		return labReceivedDate;
	}
	public void setLabReceivedDate(LocalDate labReceivedDate) {
